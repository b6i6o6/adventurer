...
% TODO: I don't need to be curious at all, I can just use A Favor for Melithar, then hear what she says as I approach. However, this is kind of cheating as this quest is supposed to be only available if you already completed Fel Moss Corruption but it doesn't make any sense since you just went there already.
